---
title: Processing the cramer2013_CML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CML subtypes from @cramer2013personalized.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE47927](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE47927).
...
path <- file.path("leukemiaAtlas", "cramer2013_CML")
