---
title: Processing the chuang2012_CLL dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CLL subtypes from @benito2012imatinib.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE39671](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE39671).
...
metadata <- metadata[str_detect(metadata$title, 'CLL'),]
metadata$title <- 'CLL'
...
path <- file.path("leukemiaAtlas", "chuang2012_CLL")
