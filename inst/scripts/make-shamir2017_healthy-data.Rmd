---
title: Processing the shamir2017_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @shamir2017analysis.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE99039](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE99039).
...
metadata <- metadata[str_detect(metadata$title, 'E7R'),]
...
```{r}
path <- file.path("leukemiaAtlas", "shamir2017_healthy")
