---
title: Processing the warren2009_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @warren2009genomic.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE11375](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE11375).
...
metadata <- metadata[str_detect(metadata$title, 'ctl'),]
...
```{r}
path <- file.path("leukemiaAtlas", "warren2009_healthy")
