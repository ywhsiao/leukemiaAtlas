---
title: Processing the krug2009_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @krug2009signature.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE17114](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE17114).
...
path <- file.path("leukemiaAtlas", "krug2009_healthy")
