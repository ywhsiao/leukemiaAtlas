---
title: Processing the clelland2013_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @clelland2013utilization.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE46449](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE46449).
...
metadata <- metadata[str_detect(metadata$title, 'Control'),]
...
path <- file.path("leukemiaAtlas", "clelland2013_healthy")
