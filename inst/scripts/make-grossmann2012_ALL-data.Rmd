---
title: Processing the grossmann2012_ALL dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the ALL subtypes from @grossmann2012ezh2.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE30599](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE30599).
...
metadata <- metadata[str_detect(metadata$title, 'ALL'),]
metadata$title <- 'ALL'
...
path <- file.path("leukemiaAtlas", "grossmann2012_ALL")
