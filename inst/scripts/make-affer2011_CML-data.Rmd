---
title: Processing the affer2011_CML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CML subtypes from @affer2011gene.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE24739](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE24739).
...
path <- file.path("leukemiaAtlas", "affer2011_CML")
