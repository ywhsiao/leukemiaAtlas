---
title: Processing the huang2010_helathy dataset
author: Yi-Wen Hsiao
...
using the accession number [GSE15932](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE15932).
...
path <- file.path("leukemiaAtlas", "huang2010_ALL")
