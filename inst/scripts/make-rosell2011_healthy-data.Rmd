---
title: Processing the rosell2011_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @rosell2011brain.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE25414](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE25414).
...
path <- file.path("leukemiaAtlas", "rosell2011_healthy")
