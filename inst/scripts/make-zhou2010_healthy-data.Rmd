---
title: Processing the zhou2010_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @zhou2010analysis.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE19743](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE19743).
...
metadata <- metadata[str_detect(metadata$title, 'HealthyControl'),]
...
```{r}
path <- file.path("leukemiaAtlas", "zhou2010_healthy")
