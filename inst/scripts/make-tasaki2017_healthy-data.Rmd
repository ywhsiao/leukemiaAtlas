---
title: Processing the tasaki2017_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @tasaki2017multiomic.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE84844](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE84844).
...
metadata <- metadata[str_detect(metadata$title, 'HC'),]
...
```{r}
path <- file.path("leukemiaAtlas", "tasaki2017_healthy")
