---
title: Processing the lauwerys2013_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @lauwerys2013down.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE39088](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE39088).
...
metadata <- metadata[str_detect(metadata$title, 'healthy individual'),]
metadata$title <- 'healthy'
...
path <- file.path("leukemiaAtlas", "lauwerys2013_healthy")
