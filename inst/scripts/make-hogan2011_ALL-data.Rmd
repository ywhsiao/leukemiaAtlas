---
title: Processing the hogan2011_ALL dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the ALL subtypes from @hogan2011integrated.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE28460](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE28460).
...
path <- file.path("leukemiaAtlas", "hogan2011_ALL")
