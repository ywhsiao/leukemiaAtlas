---
title: Processing the mcweeney2010_CML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CML subtypes from @mcweeney2010gene.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE14671](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE14671).
...
path <- file.path("leukemiaAtlas", "mcweeney2010_CML")
