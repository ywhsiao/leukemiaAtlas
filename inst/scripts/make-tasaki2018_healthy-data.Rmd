---
title: Processing the tasaki2018_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @tasaki2018multi.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE93272](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE93272).
...
metadata <- metadata[str_detect(metadata$title, 'healthy control'),]
...
```{r}
path <- file.path("leukemiaAtlas", "tasaki2018_healthy")
