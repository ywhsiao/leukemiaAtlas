#' Obtain the chuang2015_AML data
#'
#' Obtain the CML bulk RNA-seq data from Chuang et.al. (2015).
#'
#' @details
#' Column metadata is provided in the same form as supplied in GSE71014.
#' This contains information such as sample_id, study_id, platform, subtypes and/or cytogenetics risks.
#'
#' All data are downloaded from ExperimentHub and cached for local re-use.
#' Specific resources can be retrieved by searching for \code{leukemiasAtlas/chuang2015_AML}.
#'
...
#'
#' @examples
#' sce <- chuang2015_AMLData()
#'
#' @export
#'
chuang2015_AMLData <- function() {
