...
affer2011_CML <- data.frame(
  ...
  RdstaPath = file.path("leukemiaAtlas", "affer2011_CML", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
  ...
  RdstaClass=c("DataFrame", "DataFrame"),
  DispatchClass="Rds",
...
benito2012_CML <- data.frame(
  ...
  Description = sprintf("%s for bulk expression data of CML samples from GSE33075",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "benito2012_CML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
bruennert2009_CML <- data.frame(
  ...
  Description = sprintf("%s for bulk expression data of CML samples from GSE12211",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "bruennert2009_CML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
cancer2013_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from TCGA-LAML",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "cancer2013_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
...
ceroi2016_acute <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of acute leukemia samples (ALL or AML) from GSE89565",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "ceroi2016_acute_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType='TAR',
...
chuang2012_CLL <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of CLL samples from GSE39671",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "chuang2012_CLL_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType='TAR',
...
chuang2015_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from GSE71014",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "chuang2015_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType='TAR',
...
clelland2013_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE46449",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "clelland2013_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
cramer2013_CML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of CML samples from GSE47927",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "cramer2013_CML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
de2010_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from GSE22056",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "de2010_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
grossmann2012_ALL <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of ALL samples from GSE30599",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "grossmann2012_ALL_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
herold2011_CLL <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of CLL samples from GSE22762",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "herold2011_CLL_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
hogan2011_ALL <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of ALL samples from GSE28460",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "hogan2011_ALL_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
huang2010_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE15932",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "huang2010_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
klein2009_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from GSE15434",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "klein2009_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
kohlmann2008_all <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of leukemia samples (AML, ALL, CML, CLL) from GSE13159",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "kohlmann2008_all_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
kong2012_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE18123",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "kong2012_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
krug2009_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE17114",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "krug2009_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
lauwerys2013_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE39088",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "lauwerys2013_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
leday2018_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE98793",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "leday2018_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
mcweeney2010_CML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of CML samples from GSE14671",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "mcweeney2010_CML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
ng2016_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from GSE76008",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "ng2016_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
rosell2011_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE25414",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "rosell2011_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
shamir2017_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE99039",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "shamir2017_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
sharma2009_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE18781",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "sharma2009_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
staal2010_ALL <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of ALL samples from GSE18497",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "staal2010_ALL_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
tasaki2017_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE84844",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "tasaki2017_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
tasaki2018_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE93272",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "tasaki2018_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
tyner2018_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from BEAT2.0",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "tyner2018_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
verhaak2009_AML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of AML samples from GSE6891",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "verhaak2009_AML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
warren2009_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE11375",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "warren2009_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
xiao2011_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE36809",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "xiao2011_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
zhang2010_CML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of CML samples from GSE20876",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "zhang2010_CML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
zhang2013_CML <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of CML samples from GSE43225",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "zhang2013_CML_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
...
zhou2010_healthy <- data.frame(
  ...
  Description = sprintf("%s bulk expression data of healthy samples from GSE19743",
                        c("ranked expression matrix", "per-sample metadata")),
  RdstaPath = file.path("leukemiaAtlas", "zhou2010_healthy_", c("rankData.rds", "colData.rds")),
  BiocVersion="3.18",
  Genome="hg38",
  SourceType="TAR",
