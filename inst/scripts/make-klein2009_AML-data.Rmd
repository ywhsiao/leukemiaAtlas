---
title: Processing the klein2009_AML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the AML subtypes from @klein2009quantitative.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE15434](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE15434).
...
path <- file.path("leukemiaAtlas", "klein2009_AML")
