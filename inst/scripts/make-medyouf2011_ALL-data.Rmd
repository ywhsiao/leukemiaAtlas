---
title: Processing the medyouf2011_ALL dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the ALL subtypes from @medyouf2011high.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE29959](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE29959).
...
path <- file.path("leukemiaAtlas", "medyouf2011_ALL")
