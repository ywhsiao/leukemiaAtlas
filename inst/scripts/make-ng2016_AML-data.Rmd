---
title: Processing the ng2016_AML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the AML subtypes from @ng201617.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE76008](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE76008).
...
path <- file.path("leukemiaAtlas", "ng2016_AML")
