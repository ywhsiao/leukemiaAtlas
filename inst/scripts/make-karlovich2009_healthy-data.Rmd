---
title: Processing the karlovich2009_helathy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @huang2010novel.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE16028](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE16028).
...
metadata <- metadata[str_detect(metadata$title, 'Day 1'),]
...
path <- file.path("leukemiaAtlas", "karlovich2009_helathy")
