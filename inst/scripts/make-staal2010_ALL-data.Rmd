---
title: Processing the staal2010_ALL dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the ALL subtypes from @staal2010genome.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE18497](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE18497).
...
```{r}
path <- file.path("leukemiaAtlas", "staal2010_ALL")
