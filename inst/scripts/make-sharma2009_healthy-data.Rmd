---
title: Processing the sharma2009_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @sharma2009insights.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE18781](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE18781).
...
```{r}
path <- file.path("leukemiaAtlas", "sharma2009_healthy")
