---
title: Processing the benito2012_CML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CML subtypes from @benito2012imatinib.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE33075](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE33075).
...
path <- file.path("leukemiaAtlas", "benito2012_CML")
