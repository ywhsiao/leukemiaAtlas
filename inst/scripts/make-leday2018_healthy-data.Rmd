---
title: Processing the leday2018_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @leday2018replicable.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE98793](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE98793).
...
path <- file.path("leukemiaAtlas", "leday2018_healthy")
