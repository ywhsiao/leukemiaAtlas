---
title: Processing the zhang2010_CML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CML subtypes from @zhang2010effective.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE20876](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE20876).
...
```{r}
path <- file.path("leukemiaAtlas", "zhang2010_CML")
