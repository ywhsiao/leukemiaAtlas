---
title: Processing the zhang2013_CML dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the CML subtypes from @zhang2013microenvironmental.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE43225](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE43225).
...
metadata$platform <- 'HuGene-1_0-st'
head(metadata)
```
...
path <- file.path("leukemiaAtlas", "zhang2013_CML")
