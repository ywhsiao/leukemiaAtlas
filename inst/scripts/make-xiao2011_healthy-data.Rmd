---
title: Processing the xiao2011_healthy dataset
author: Yi-Wen Hsiao
...
We obtain a bulk RNA sequencing dataset of the healthy subtypes from @xiao2011genomic.
Expression matrix for endogenous genes are available from the Gene Expression Omnibus
using the accession number [GSE36809](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE36809).
...
```{r}
path <- file.path("leukemiaAtlas", "xiao2011_healthy")
